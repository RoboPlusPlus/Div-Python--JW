...
if __name__ == "__main__":
    ...
    client = Client("opc.tcp://10.181.5.32:49320/OPCUA/LørenMaster/") #127.0.0.1
    ...
    try:
        ...
        tag1 = client.get_node("ns=2;s=LørenMaster.pls.asdasd2")
        print("tag1 is: {0} with value {1} ".format(tag1, tag1.get_value()))
        tag2 = client.get_node("ns=2;s=LørenMaster.pls.asdasd3")
