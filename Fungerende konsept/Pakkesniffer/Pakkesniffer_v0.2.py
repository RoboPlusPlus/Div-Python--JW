...
def main(_max_packet_count):
    ...
    while packet_count <= _max_packet_count:
        # Recive data
        ...
        all_mac_addresses.add(dest_mac)
        all_mac_addresses.add(src_mac)
    ...
    for mac_address in all_mac_addresses:
        ...
        try:
            ...
            print("Cannot resolve MAC-address: " + mac_address)
